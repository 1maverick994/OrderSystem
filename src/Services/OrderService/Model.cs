...
/*
            modelBuilder.Entity<OrderLine>().HasData(new OrderLine[] {
                    new OrderLine() { Id = 1, ProductId = 2, Order = order1, Quantity = 10 } ,
                    new OrderLine() { Id = 2, ProductId = 3, Order = order1, Quantity = 3 },
                    new OrderLine() { Id = 3, ProductId = 1, Order = order2, Quantity =1 } ,
                    new OrderLine() { Id = 4, ProductId = 2, Order = order2, Quantity = 1 }
            });
 */
        }
